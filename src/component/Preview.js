            ...
            <div className="preview-container">
                <div className="preview-player">
                    <div style={{
                        ...
                        <img src="https://occ-0-4959-988.1.nflxso.net/dnm/api/v6/9pS1daC2n6UGc3dUogvWIPMR_OU/AAAABcUFAFOe_Tmsx6d5YLpnmd-cbhVWYeEbolv4SRE_SbiFe0BsgN86EXqDeJ6p-tq7YO_LdQfnwXVPg5KRaI_LzchMDDJf-g-BuqTS.webp?r=71a"
                        style={{
                            position:"absolute",
                            width:"100%",
                            height:"100%",
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <div className="player-name">
                                <img src="https://occ-0-4959-988.1.nflxso.net/dnm/api/v6/tx1O544a9T7n8Z_G12qaboulQQE/AAAABV7XmIlcjvF83aaO_QaDAvI2D3t_df_VX5UkzDt0eTjvD4prnRqMI0FEskIxZtTuN4VidihEUEmstsyzxS2xuMOG4lZsKDl0AJkg7wS0Vyk.webp?r=209"
                                style={{
                                    width:"100%",
                                    marginBottom:"1.5em"
                                }}></img>
                        ...
                        <div className="vol-control">
                            <button className="btncontrol">
                                <div style={{
                                    ...
                                    <svg width={24} height={24} viewBox="0 0 24 24" >
                                        <path d="M11 4.00003C11 3.59557 10.7564 3.23093 10.3827 3.07615C10.009 2.92137 9.57889 3.00692 9.29289 3.29292L4.58579 8.00003H1C0.447715 8.00003 0 8.44774 0 9.00003V15C0 15.5523 0.447715 16 1 16H4.58579L9.29289 20.7071C9.57889 20.9931 10.009 21.0787 10.3827 20.9239C10.7564 20.7691 11 20.4045 11 20V4.00003ZM5.70711 9.70714L9 6.41424V17.5858L5.70711 14.2929L5.41421 14H5H2V10H5H5.41421L5.70711 9.70714ZM15.2929 9.70714L17.5858 12L15.2929 14.2929L16.7071 15.7071L19 13.4142L21.2929 15.7071L22.7071 14.2929L20.4142 12L22.7071 9.70714L21.2929 8.29292L19 10.5858L16.7071 8.29292L15.2929 9.70714Z" fillRule="evenodd" fill="#fff"></path>
                                    </svg>
                                </div>
                            </button>           
                        </div>
                ...
                <div className="preview-close" onClick={handlePopup}>
                    <svg width={24} height={24} viewBox="0 0 24 24" >
                        <path d="M2.29297 3.70706L10.5859 12L2.29297 20.2928L3.70718 21.7071L12.0001 13.4142L20.293 21.7071L21.7072 20.2928L13.4143 12L21.7072 3.70706L20.293 2.29285L12.0001 10.5857L3.70718 2.29285L2.29297 3.70706Z" fillRule="evenodd" fill="#fff"></path>
                    </svg>
                </div>
                                    ...
                                    <div className="detail-info">
                                        <div className="videoMetadata-container">
                                            ...
                                            <div className="videoMetadata-second">
                                                <div className="year" style={{marginRight:"0.5em"}}>2022</div>
                                                <Link to="/">
                                                    <span className="rating-num">15+</span>
                                                </Link>
                                                <span className="duration" style={{marginRight:"0.5em"}}>에피소드 16개</span>
                                        ...
                                        <button className="btncontrol" 
                                            ...
                                            <div>
                                                <svg width={24} height={24} viewBox="0 0 24 24">
                                                    ...
                                                    d={isClick?"M19.293 16.7071L12.0001 9.41421L4.70718 16.7071L3.29297 15.2929L11.293 7.29289C11.4805 7.10536 11.7349 7 12.0001 7C12.2653 7 12.5196 7.10536 12.7072 7.29289L20.7072 15.2929L19.293 16.7071Z"
                                ...
                                <div className="section-divider">
                                    <button className="btncontrol" 
                                        ...
                                        <div>
                                            <svg width={24} height={24} viewBox="0 0 24 24">
                                                <path fill="#fff" fillRule="evenodd" 
                                                d={isClick2?"M19.293 16.7071L12.0001 9.41421L4.70718 16.7071L3.29297 15.2929L11.293 7.29289C11.4805 7.10536 11.7349 7 12.0001 7C12.2653 7 12.5196 7.10536 12.7072 7.29289L20.7072 15.2929L19.293 16.7071Z"
                                                :"M19.293 7.29297L12.0001 14.5859L4.70718 7.29297L3.29297 8.70718L11.293 16.7072C11.4805 16.8947 11.7349 17.0001 12.0001 17.0001C12.2653 17.0001 12.5196 16.8947 12.7072 16.7072L20.7072 8.70718L19.293 7.29297Z"
                                                }
                                                ></path>
                                            </svg>
                        ...
                        <div className="content-container">
                            <div className="about-wrapper">
                                ...
                                <div className="about-container">
                                    <AboutTagItem title="크리에이터:" content="유인석, 문지원"></AboutTagItem>
                                    <AboutTagItem title="출연:" content="박은빈, 강태오, 강기영"></AboutTagItem>
                                    <AboutTagItem title="장르:" content="TV 프로그램·법정한국 드라마, 사회 문제를 다룬 드라마, 드라마"></AboutTagItem>
                                    <AboutTagItem title="시리즈 특징:" content="힐링, 감명을 주는, 진심 어린"></AboutTagItem>
                                    <AboutTagItem title="관람등급:" rating="15" content="15세이상관람가"></AboutTagItem>
